...
# 1. Initialize persistent storage directories (fast, non-recursive)
echo "[Apex] Preparing persistent directories in /data/Stirling..."
...
chmod -R 777 /data/Stirling /tmp 2>/dev/null || true
